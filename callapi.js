...
async function transferToken(fromAddress, toAddress, tokenID, amount) {
  try {
    const result = await erc1155Contract.methods.safeTransferFrom(
      fromAddress,
      toAddress,
      tokenID,
      amount,
...
async function mintToken(fromAddress, tokenID, amount) {
    try {
      const result = await erc1155Contract.methods.mint(
        fromAddress,
        tokenID,
        amount,
        '0x'
...
//const fromAddress = '0xF42BEb728B2a5A5a7277152A541D39B26b8110ca';
///const toAddress = '0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db';
//const tokenID = 1;
//const amount = 5;
//mintToken(fromAddress,tokenID, amount)
//getBalance(fromAddress, tokenID);
//transferToken(fromAddress, toAddress, tokenID, amount);
module.exports = {
	mintToken: mintToken,
